...
sudo bash sdkmanager "platforms;android-29" "platforms;android-33" "build-tools;33.0.2" "build-tools;29.0.2" "build-tools;30.0.3" "extras;google;m2repository" "extras;android;m2repository";
#↑install android sdk
#↓install JDK 8 
